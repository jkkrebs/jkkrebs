...
class Emission_GUI(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle('Emission Measurement GUI')    
        
        self.pushButton_startscan.clicked.connect(self.emis_scan)
    ...
    def emis_scan(self):
        ...
        while l < self.end_lambda + self.step_size:
            ...
            data.append(np.array([float(position[1]/18),float(xchan),float(ychan)]))
            # update plot
